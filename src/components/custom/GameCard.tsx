...
const GameCard = ({ item }: Props) => {
    return (
        <div className="w-full pt-14 relative text-white text-opacity-80">
            <h1 className="font-wallpoet text-7xl">{item.heading}</h1>
            ...
            <div className="flex gap-[2px] items-center mt-5 ml-1">
